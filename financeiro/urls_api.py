...
urlpatterns = [
    ...
    path('fornecedores/<int:pk>/compra-marcacao-paga/', views_api.FornecedorCompraMarcacaoPaga.as_view()),
    path('fornecedores/<int:pk>/', views_api.FornecedorDetail.as_view()),
    path('produtos/', views_api.ProdutoListCreate.as_view()),
    path('produtos/bulk-precos/', views_api.ProdutoBulkPrecos.as_view()),
    path('produtos/<int:pk>/', views_api.ProdutoDetail.as_view()),
    path('materiais/', views_api.MaterialListCreate.as_view()),
    path('materiais/bulk-precos/', views_api.MaterialBulkPrecos.as_view()),
    ...
    path('impressoes/', views_api.ImpressaoListCreate.as_view()),
    path('impressoes/<int:pk>/', views_api.ImpressaoDetail.as_view()),
    ...
    path('pagamentos/cliente/<int:pk>/', views_api.PagamentoClienteDetail.as_view()),
    path('pagamentos/fornecedor/<int:pk>/', views_api.PagamentoFornecedorDetail.as_view()),
